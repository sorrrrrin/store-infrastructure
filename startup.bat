...
start cmd /k "echo kubectl port-forward svc/catalog-service -n backend 8180:8080 && kubectl port-forward svc/catalog-service -n backend 8180:8080"
start cmd /k "echo kubectl port-forward svc/order-service -n dev 8181:8081 && kubectl port-forward svc/order-service -n dev 8181:8081"
start cmd /k "echo kubectl port-forward svc/user-service -n dev 8182:8082 && kubectl port-forward svc/user-service -n dev 8182:8082"
